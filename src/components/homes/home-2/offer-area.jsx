...
const offering_data = [
    {
        ...
        description: <>Increase your search rankings and attract high-quality, relevant traffic</>
    },
    {
        id: 2,
        img: offering_img_2,
        title: <>Website Design <br />& Development</>, 
        description: <>Boost your digital marketing performance with a well-optimized website</>
    },
    {
        id: 3,
        img: offering_img_3,
        title: <>Social Media <br />Marketing</>, 
        description: <>Elevate your brand story across online channels with unique presence</>
    },
    {
        id: 4,
        img: offering_img_4,
        title: <>Pay Per Click <br /> PPC</>, 
        description: <>Optimize your search engine visibility and capture valuable leads</>
    },
]
               ...
               <div className="row align-items-center">
                  <div className="col-lg-8">
                     <div className="tp-feature-title-wrapper">
                        <h3 className="tp-section-title">Our Digital Marketing Services
