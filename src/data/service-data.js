...
const service_data = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Leverage our team of skilled writers at Lumenta Digital to craft SEO-friendly content for your website. Whether creating share-worthy blog posts or optimizing existing service and product pages with additional content, we ensure your website stays in favor of search engines by consistently adding new, valuable material. ",
      },
      {
        title: "Conversion Rate Optimization (CRO) ",
        description:
          "Increase your customers' lifetime value and boost online revenue with Lumenta Digital's Conversion Rate Optimization (CRO) services. Our integrated approach combines pay-per-click marketing with advanced SEO services to maximize conversion opportunities.  ",
      },
    ],
  ...
  },
  {
    ...
    title: (
      <>
        Voice Over <br /> Internet Protocol
      </>
    ),
    img: service_img_2,
    description: (
  ...
  },
  {
    ...
    title: (
      <>
        Mobile and <br /> Remote Networking
      </>
    ),
    img: service_img_4,
    description: (
